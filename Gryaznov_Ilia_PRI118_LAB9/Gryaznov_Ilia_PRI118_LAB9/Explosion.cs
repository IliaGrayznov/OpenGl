...
namespace Gryaznov_Ilia_PRI118_LAB9
{
    class Explosion
    {
        ...
        private void CreateDisplayList()
        {
            ...
            Gl.glVertex3d(0.02, 0, 0.12);
            Gl.glVertex3d(0.062f, 0, 0.1);
            Gl.glVertex3d(0.049f, 0, 0.089f);        
            Gl.glEnd();

            Gl.glBegin(Gl.GL_TRIANGLES);
            Gl.glVertex3d(0.070f, 0, 0.076);
            Gl.glVertex3d(0.056, 0, 0.061f);
            Gl.glVertex3d(0.023, 0, 0.084f);
            Gl.glEnd();

            Gl.glBegin(Gl.GL_TRIANGLES);
            Gl.glVertex3d(0.070f, 0, 0.076);
            Gl.glVertex3d(0.023, 0, 0.084f);
            Gl.glVertex3d(0.040, 0, 0.099f);
            Gl.glEnd();

            Gl.glBegin(Gl.GL_TRIANGLES);
            Gl.glVertex3d(0.04f, 0, 0.072);
            Gl.glVertex3d(0.0235, 0, 0.053f);
            Gl.glVertex3d(0.054, 0.01, 0.02f);
            Gl.glEnd();

            Gl.glBegin(Gl.GL_TRIANGLES);
            Gl.glVertex3d(0.04f, 0, 0.072);
            Gl.glVertex3d(0.054, 0, 0.02f);
            Gl.glVertex3d(0.0795, 0, 0.046f);
            Gl.glEnd();
        ...
        public void Boooom(float time_start)
        {
            ...
            {
                // создаем частицу
                PartilceArray[ax] = new Partilce(position[0], position[1], position[2], 20.0f, 5, time_start);
